export default [{
  //              
 //First User on the HomeChatScreen  
 // 
  id: '1',
  users: [{
    id: 'u1',
  ...
  //              
 //Second User on the HomeChatScreen  
 //             
{ id: '2',
  users: [{
    id: 'u1',
 ...
 //              
 //Third User on the HomeChatScreen  
 // 
 {
  id: '3',
  users: [{
  ...
  //              
 //Fourth User on the HomeChatScreen  
 // 
  {
  id: '4',
  users: [{
  ...
  lastMessage: {
   ...
   //              
 //Fifth User on the HomeChatScreen  
 // 
   {
  id: '5',
  users: [{
...
//              
//Sixth User on the HomeChatScreen  
// 
   {
  id: '6',
  users: [{
  ...
  //              
 //Seventh User on the HomeChatScreen  
 // 
   {
  id: '7',
  users: [{
  ...
  //              
 //Eight User on the HomeChatScreen  
 // 
   {
  id: '8',
  users: [{
...
//              
//ninth User on the HomeChatScreen  
// 
